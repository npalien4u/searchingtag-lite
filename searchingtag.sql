...
--
-- Table structure for table `AgoraVideoCall`
--

CREATE TABLE `AgoraVideoCall` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `AppsSessions`
--

CREATE TABLE `AppsSessions` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `Apps_Hash`
--

CREATE TABLE `Apps_Hash` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `BlogMovieDisLikes`
--

CREATE TABLE `BlogMovieDisLikes` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `BlogMovieLikes`
--

CREATE TABLE `BlogMovieLikes` (
  `id` int(11) NOT NULL,
  `blog_comm_id` int(20) NOT NULL DEFAULT 0,
  `blog_commreply_id` int(20) NOT NULL DEFAULT 0,
  `movie_comm_id` int(20) NOT NULL DEFAULT 0,
...
INSERT INTO `Blogs_Categories` (`id`, `lang_key`) VALUES
(2, '1421'),
(3, '1424'),
(4, '1427'),
(5, '1430'),
...
--
-- Table structure for table `Colored_Posts`
--

CREATE TABLE `Colored_Posts` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `CommentWonders`
--

CREATE TABLE `CommentWonders` (
  `id` int(11) NOT NULL,
  `post_id` int(11) NOT NULL DEFAULT 0,
  `comment_id` int(11) NOT NULL DEFAULT 0,
  `user_id` int(11) NOT NULL DEFAULT 0
...
--
-- Table structure for table `Comment_Replies_Likes`
--
...
--
-- Table structure for table `Comment_Replies_Wonders`
--

CREATE TABLE `Comment_Replies_Wonders` (
  `id` int(11) NOT NULL,
  `reply_id` int(11) NOT NULL DEFAULT 0,
  `user_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `Egoing`
--
...
--
-- Table structure for table `Einterested`
--

CREATE TABLE `Einterested` (
  `id` int(11) NOT NULL,
  `event_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `Einvited`
--

CREATE TABLE `Einvited` (
  `id` int(11) NOT NULL,
  `event_id` int(11) NOT NULL,
...
--
-- Table structure for table `ForumThreadReplies`
--

CREATE TABLE `ForumThreadReplies` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `Funding_Raise`
--

CREATE TABLE `Funding_Raise` (
  `id` int(11) NOT NULL,
...
INSERT INTO `Groups_Categories` (`id`, `lang_key`) VALUES
(2, '1420'),
(3, '1423'),
(4, '1426'),
(5, '1429'),
...
INSERT INTO `Job_Categories` (`id`, `lang_key`) VALUES
(1, '1580'),
(2, '1581'),
(3, '1582'),
(4, '1583'),
...
INSERT INTO `Langs` (`id`, `lang_key`, `type`, `english`, `arabic`, `dutch`, `french`, `german`, `italian`, `portuguese`, `russian`, `spanish`, `turkish`) VALUES
...
INSERT INTO `Manage_Pro` (`id`, `type`, `price`, `featured_member`, `profile_visitors`, `last_seen`, `verified_badge`, `posts_promotion`, `pages_promotion`, `discount`, `image`, `night_image`, `status`, `time`) VALUES
...
--
-- Table structure for table `MovieCommentReplies`
--

CREATE TABLE `MovieCommentReplies` (
  `id` int(11) NOT NULL,
  `comm_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `Mute_Story`
--

CREATE TABLE `Mute_Story` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL DEFAULT 0,
...
INSERT INTO `Pages_Categories` (`id`, `lang_key`) VALUES
(2, '1419'),
(3, '1422'),
(4, '1425'),
(5, '1428'),
...
--
-- Table structure for table `PatreonSubscribers`
--

CREATE TABLE `PatreonSubscribers` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL DEFAULT 0,
...
INSERT INTO `Products_Categories` (`id`, `lang_key`) VALUES
(1, '1470'),
(2, '1471'),
(3, '1472'),
(4, '1473'),
...
INSERT INTO `Reactions_Types` (`id`, `name`, `wowonder_icon`, `sunshine_icon`, `status`) VALUES
(1, 'like', '', '', 1),
(2, 'love', '', '', 1),
(3, 'haha', '', '', 1),
(4, 'wow', '', '', 1),
...
--
-- Table structure for table `UserCertification`
--
...
INSERT INTO `UserLanguages` (`id`, `lang_key`) VALUES
(1, 'Afrikaans_af'),
(2, 'Albanian_sq'),
(3, 'Amharic_am'),
(4, 'Arabic_ar'),
...
--
-- Table structure for table `UserOpenTo`
--

CREATE TABLE `UserOpenTo` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Indexes for table `AgoraVideoCall`
--
ALTER TABLE `AgoraVideoCall`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `AppsSessions`
--
ALTER TABLE `AppsSessions`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `Apps_Hash`
--
ALTER TABLE `Apps_Hash`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `BlogMovieDisLikes`
--
ALTER TABLE `BlogMovieDisLikes`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `BlogMovieLikes`
--
ALTER TABLE `BlogMovieLikes`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `Colored_Posts`
--
ALTER TABLE `Colored_Posts`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `CommentWonders`
--
ALTER TABLE `CommentWonders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `post_id` (`post_id`),
  ADD KEY `comment_id` (`comment_id`),
  ADD KEY `user_id` (`user_id`);
...
--
-- Indexes for table `Comment_Replies_Likes`
--
ALTER TABLE `Comment_Replies_Likes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `reply_id` (`reply_id`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `Comment_Replies_Wonders`
--
ALTER TABLE `Comment_Replies_Wonders`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `Einterested`
--
ALTER TABLE `Einterested`
  ADD PRIMARY KEY (`id`),
  ADD KEY `event_id` (`event_id`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `Einvited`
--
ALTER TABLE `Einvited`
  ADD PRIMARY KEY (`id`),
  ADD KEY `event_id` (`event_id`),
...
--
-- Indexes for table `ForumThreadReplies`
--
ALTER TABLE `ForumThreadReplies`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `Funding_Raise`
--
ALTER TABLE `Funding_Raise`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
...
--
-- Indexes for table `GroupChatUsers`
--
ALTER TABLE `GroupChatUsers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `group_id` (`group_id`),
  ADD KEY `active` (`active`);
...
--
-- Indexes for table `HiddenPosts`
--
ALTER TABLE `HiddenPosts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `post_id` (`post_id`),
  ADD KEY `user_id` (`user_id`);
...
--
-- Indexes for table `MovieCommentReplies`
--
ALTER TABLE `MovieCommentReplies`
  ADD PRIMARY KEY (`id`),
  ADD KEY `comm_id` (`comm_id`),
  ADD KEY `movie_id` (`movie_id`),
  ADD KEY `user_id` (`user_id`);
...
--
-- Indexes for table `Mute_Story`
--
ALTER TABLE `Mute_Story`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `PageRating`
--
ALTER TABLE `PageRating`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `page_id` (`page_id`);
...
--
-- Indexes for table `PatreonSubscribers`
--
ALTER TABLE `PatreonSubscribers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
...
--
-- Indexes for table `Reactions_Types`
--
ALTER TABLE `Reactions_Types`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `UserCertification`
--
...
--
-- Indexes for table `UserOpenTo`
--
ALTER TABLE `UserOpenTo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
...
--
-- Indexes for table `UserStoryMedia`
--
...
--
-- AUTO_INCREMENT for table `AgoraVideoCall`
--
ALTER TABLE `AgoraVideoCall`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `AppsSessions`
--
ALTER TABLE `AppsSessions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `Apps_Hash`
--
ALTER TABLE `Apps_Hash`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `BlogMovieDisLikes`
--
ALTER TABLE `BlogMovieDisLikes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `BlogMovieLikes`
--
ALTER TABLE `BlogMovieLikes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `Colored_Posts`
--
ALTER TABLE `Colored_Posts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `CommentWonders`
--
ALTER TABLE `CommentWonders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `Comment_Replies_Likes`
--
ALTER TABLE `Comment_Replies_Likes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `Comment_Replies_Wonders`
--
ALTER TABLE `Comment_Replies_Wonders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `Egoing`
--
ALTER TABLE `Egoing`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `Einterested`
--
ALTER TABLE `Einterested`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `Einvited`
--
ALTER TABLE `Einvited`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `ForumThreadReplies`
--
ALTER TABLE `ForumThreadReplies`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `Funding_Raise`
--
ALTER TABLE `Funding_Raise`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `GroupChatUsers`
--
ALTER TABLE `GroupChatUsers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `HiddenPosts`
--
ALTER TABLE `HiddenPosts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `Manage_Pro`
--
ALTER TABLE `Manage_Pro`
...
--
-- AUTO_INCREMENT for table `MovieCommentReplies`
--
ALTER TABLE `MovieCommentReplies`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `Mute_Story`
--
ALTER TABLE `Mute_Story`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `PageAdmins`
--
ALTER TABLE `PageAdmins`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `PageRating`
--
ALTER TABLE `PageRating`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `PatreonSubscribers`
--
ALTER TABLE `PatreonSubscribers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `Reactions_Types`
--
ALTER TABLE `Reactions_Types`
...
--
-- AUTO_INCREMENT for table `UserCertification`
--
ALTER TABLE `UserCertification`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `UserOpenTo`
--
ALTER TABLE `UserOpenTo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `UserStoryMedia`
--
ALTER TABLE `UserStoryMedia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
